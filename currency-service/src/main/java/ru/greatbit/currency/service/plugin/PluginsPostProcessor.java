...
public class PluginsPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object o, String s) throws BeansException {
        ...
        if (annotation != null){
            ...
            Map<Class, Map<String, Object>> plugins = pluginContainer.getPlugins();
            Map <String, Object> pluginsForClass = plugins.get(annotation.contract());

            if (pluginsForClass == null){
                pluginsForClass = new HashMap<>();
            }
            pluginsForClass.put(name, o);
            pluginContainer.getPlugins().put(annotation.contract(), pluginsForClass);
        }
        return o;
    }
